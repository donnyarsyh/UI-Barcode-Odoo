import 'package:barcode_odoo/manufacturing/setManufacturing.dart';
import 'package:flutter/material.dart';
import '../setting.dart';
import '../addProduk.dart';
import 'setManufacturing.dart';

class ScanManufacturingPage extends StatefulWidget {
  const ScanManufacturingPage({super.key});

  @override
  State<ScanManufacturingPage> createState() => _ScanManufacturingPageState();
}

class _ScanManufacturingPageState extends State<ScanManufacturingPage> {
