...
class ScanPosOrderPage extends StatefulWidget {
  const ScanPosOrderPage({super.key});

  @override
  State<ScanPosOrderPage> createState() => _ScanPosOrderPageState();
}

class _ScanPosOrderPageState extends State<ScanPosOrderPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('PosOrder', style: TextStyle(color: Colors.white)),
      ),
      body: SafeArea(
        child: Padding(
